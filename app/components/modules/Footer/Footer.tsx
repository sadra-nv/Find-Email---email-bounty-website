...
export default function Footer() {
  return (
    <>
    <div className="bg-gradient-to-b from-[#8F5CE1] to-[#2E2291] mt-20 xl:mt-52">
          ...
          <div className="b l flex justify-between md:flex-row-reverse w-full">
            ...
            <div className="flex items-center">
              <ul className="flex flex-col items-center justify-center  gap-5 md:gap-3  text-xs font-normal md:grid md:grid-cols-2 h-fit">
                <li className="">
                  <img className="md:hidden" src="/icons/Twitter1.svg" alt="" />
                  <img className="hidden md:block" src="/icons/Twitter1md.svg" alt="" />
                </li>
                <li className="">
                  <img className="md:hidden" src="/icons/Instagram1.svg" alt="" />
                  <img className="hidden md:block" src="/icons/Instagrammd1.svg" alt="" />
                </li>
                <li className="">
                  <img className="md:hidden" src="/icons/Facebook2.svg" alt="" />
                  <img className="hidden md:block" src="/icons/Facebookmd2.svg" alt="" />
                </li>
                <li className="">
                  <img className="md:hidden" src="/icons/LinkedIn.svg" alt="" />
                  <img className="hidden md:block" src="/icons/LinkedInmd.svg" alt="" />
                </li>
              </ul>
            </div>
          </div>
