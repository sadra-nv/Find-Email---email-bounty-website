  ...
  return (
    <form className="sm:px-20">
      ...
      <div className=" text-fe-c-text-title font-semibold my-4 sm:mt-5">
        <p className="text-sm sm:text-base text-center">Delete account?</p>
        <p
          className="text-xs sm:text-sm  font-medium
          text-center w-fit mx-auto  mt-4 sm:mt-5 mb-6 sm:mb-8"
        >
          You will not be able to access your account and all your
          <br className="hidden sm:block" /> saved data will be lost.
        </p>
