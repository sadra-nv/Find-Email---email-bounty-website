export default function SiteOverviewArc() {
  return (
    <div
      className="pt-14 md:pt-6 w-full h-56 md:h-96 overflow-hidden flex justify-center items-center translate-y-16 md:translate-y-0  
      "
    >
      <div
        className="bg-blog-arc-main w-[1000px] h-[1000px]  rounded-full glowing-circle
