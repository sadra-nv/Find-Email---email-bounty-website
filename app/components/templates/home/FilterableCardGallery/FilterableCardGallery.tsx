        ...
        <div className="">
            <div className="container">
                <div className="grid grid-cols-7 gap-6">
                    ...
                    <div className="col-span-5 grid grid-cols-2 gap-16">
                        <div className="">
                            <div className="relative flex justify-center items-center">
                                <img className="mix-blend-lighten" src="/images/ii.png" alt="" />
                                <img className="absolute top-16" src="/images/bitcoincore.png" alt="" />
                            </div>
                            <div className="flex flex-col gap-4">
                                ...
                                <button className='w-fit'>
                                    <Link href={'/'} className='flex items-center gap-1 py-4 px-5 rounded-lg text-xs text-white bg-gradient-to-t from-[#2E2291] to-[#8F5CE1]'>
                                        Login/Register
